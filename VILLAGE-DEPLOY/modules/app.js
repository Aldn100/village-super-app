...
(function (global) {
  ...
  var VILLAGE_DEFAULT_CURRENCY = 'TZS';
  ...
  function loadStoredCurrency() {
    ...
    return VILLAGE_DEFAULT_CURRENCY;
  }
  ...
  function initGlobalCurrencySelect() {
    ...
    mergeFxExtensions();
    refreshAllPricingDisplays();
    console.log('[VillageCurrency] Global fiat selector ready —', VILLAGE_FIAT_CURRENCIES.length, 'currencies (default: TZS).');
  }
